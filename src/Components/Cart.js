            ...
            {cartProducts.length > 0 && (
                <div className='container-fluid'>
                    ...
                    <div className='summary-box'>
                        ...
                        <br></br>
                        <div>
                        Количество продуктов: <span>{totalQty}</span>
                        </div>
                        <div>
                        Сумма к оплате: <span>₽ {totalPrice}</span>
                        </div>
                        <br></br>
                        
                         
                        <button className='btn btn-secondary btn-md' 
                        onClick={()=>triggerModal()}>Заказать доставку</button>                                                                                                                                             
                    </div>                                    
                </div>
            )}
            {cartProducts.length < 1 && (
                <div className='container-fluid'>Нет продуктов к оплате</div>
            ) }

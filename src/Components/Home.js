...
export const Home = (props) => {
    ...
    return (
        <>
            ...
            <h6><div className='Vern'><button onClick={returntoAllProducts} class='dropbtn'>Всё меню</button></div></h6>
            <div className='dropdown-content'>
                    {spans.map((individualSpan,index)=>(
                        <span
                        
                        key={index} id={individualSpan.id}
                ...
                {filteredProducts.length < 1&&(
                    <>
                        {products.length > 0&&(
                            <div className='my-products'>
                                ...
                                transition={{
                                 ...
                                 className='text-center'>Всё Меню</motion.h1>
                        ...
                        {products.length < 1&&(
                            <div className='my-products please-wait'>Подождите...</div>
                        )}
                    </>
                )}
            </div>       
